...
void ReadIUHFromMongoDB(gridfs *spatialData, string &remoteFilename, clsRasterData *templateRaster, int &n,
                        float **&data)
{
    gridfile gfile[1];
    bson b[1];
    ...
    if (0 != flag)
        throw ModelException("MongoUtil.cpp", "Read2DArrayFromMongoDB",
...
void Read2DArrayFromMongoDB(gridfs *spatialData, string &remoteFilename, clsRasterData *templateRaster, int &n,
                            float **&data)
{
    gridfile gfile[1];
    bson b[1];
    ...
    int flag = gridfs_find_query(spatialData, b, gfile);
    if (0 != flag)
        throw ModelException("ModuleParamter", "Read2DArrayFromMongoDB",
                             "Failed in  gridfs_find_query filename: " + remoteFilename + "\n");
...
void Read1DArrayFromMongoDB(gridfs *spatialData, string &remoteFilename, clsRasterData *templateRaster, int &num,
                            float *&data)
{
    gridfile gfile[1];
    bson b[1];
...
void ReadMutltiReachInfoFromMongoDB(LayeringMethod layeringMethod, string &dbName, gridfs *spatialData,
...
void ReadReachInfoFromMongoDB(LayeringMethod layeringMethod, string &dbName, gridfs *spatialData, int nSubbasin,
                              string remoteFilename, clsRasterData *templateRaster, int &nr, int &nc, float **&data)
{
    bson b[1];
    bson_init(b);
    bson_append_start_object(b, "$query");
