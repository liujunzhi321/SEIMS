...
extern "C" SEIMS_MODULE_API const char *MetadataInformation()
{
    ...
    mdi.AddOutput("TSolActP", "kg P/ha", "amount of phosphorus transferred between the soluble and active mineral pool",
                  DT_Array2D);
    mdi.AddOutput("TStaActP", "kg P/ha", "amount of phosphorus transferred between the active and stable mineral pools",
                  DT_Array2D);
