...
extern "C" SEIMS_MODULE_API const char *MetadataInformation()
{
    ...
    mdi.AddParameter("Chs0", "m3/m", "initial channel storage per meter of reach length", "ParameterDB_Discharge",
                     DT_Single);
    ...
    mdi.AddInput("SNITTOCH", "kg", "surface nitrate to channel from each subbasin", "Module",
                 DT_Array1D);  // for longterm model
    ...
    mdi.AddInput("ORGNTOCH", "kg", "the amount of organic nitrogen transported to channel in surface runoff", "Module",
                 DT_Array1D);
    mdi.AddInput("ATTPTOCH", "kg",
                 "the amount of phosphorus attached to sediment transported to channel in surface runoff", "Module",
                 DT_Array1D);
    ...
    mdi.AddInput("QRECH", "", "Discharge in a text format at each reach outlet and at each time step", "Module",
                 DT_Array1D);
    ...
    mdi.AddOutput("ATTPOUTLET", "kg", "phosphorus attached to sediment concentration at the watershed outlet",
                  DT_Array1D);
