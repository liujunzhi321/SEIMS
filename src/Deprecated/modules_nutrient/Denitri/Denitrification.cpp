...
Denitrification::Denitrification(void) : m_nLayers(3), m_size(-1), m_denRC(1.4f), m_Nitrate(NULL), m_TF(NULL),
                                         m_WF(NULL), m_orgCar(NULL), m_denWF(NULL),  //input
...
bool Denitrification::CheckInputData(void)
{
    if (m_size <= 0)
    {
        throw ModelException("Denitrification", "CheckInputData",
    ...
    {
        throw ModelException("Denitrification", "CheckInputData",
                             "The layers number of the input can not be less than zero.");
        return false;
    }
    if (m_denRC <= 0)
    {
        throw ModelException("Denitrification", "CheckInputData",
                             "The rate coefficient for denitrification of the input can not be less than zero.");
        return false;
    }
    if (m_Nitrate == NULL)
    {
    ...
    if (m_TF == NULL)
        throw ModelException("Denitrification", "CheckInputData",
                             "You have not set the nutrient cycling temperature factor.");
    if (m_WF == NULL)
        throw ModelException("Denitrification", "CheckInputData",
                             "You have not set the nutrient cycling water factor.");
/*	if(m_denWF == NULL)
	{
...
{
    if (m_size <= 0)
        throw ModelException("Denitrification", "initialOutputs",
                             "The cell number of the input can not be less than zero.");
