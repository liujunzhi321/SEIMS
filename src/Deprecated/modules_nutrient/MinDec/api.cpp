...
extern "C" SEIMS_MODULE_API const char *MetadataInformation()
{
    ...
    mdi.AddParameter("RateCoeH", "", "rate coefficient for mineralization of the humus active organic nutrients",
                     "file.in", DT_Single);
    mdi.AddParameter("RateCoeR", "", "rate coefficient for mineralization of the residue fresh organic nutrients",
                     "file.in", DT_Single);
    ...
    mdi.AddOutput("TraOrgN", "kg N/ha", "amount of nitrogen transferred between the active and stable organic pools",
                  DT_Array2D);
