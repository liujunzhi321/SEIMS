...
ArealParameter::ArealParameter(int id) :
        m_id(id), m_description(""), m_name("")
{
}

ArealParameter::ArealParameter(int id, string name, string descri) :
        m_id(id), m_name(name), m_description(descri)
{
}
...
ArealParameter::ArealParameter(vector<string> *oneRow)
{
    ...
    if (int(oneRow->size()) < 3)
        throw ModelException("ArealParameter", "ArealParameter", "oneRow should have 3 parameters at least!");
