...
{
	if(int(oneRow->size()) < TILLAGE_PARAM_COUNT)	throw ModelException("TillageParameter","TillageParameter","oneRow should have 5 parameters at least!");
...
{
	if(count != TILLAGE_PARAM_COUNT)	throw ModelException("TillageParameter","TillageParameter","The size of tillage parameter fields should be 7!");
