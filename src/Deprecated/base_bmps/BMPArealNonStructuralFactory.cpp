...
BMPArealNonStructuralFactory::BMPArealNonStructuralFactory(int scenarioId,int bmpId,
	int bmpType,string distribution,string parameter):BMPFactory(scenarioId,bmpId,bmpType,distribution,parameter)
{
...
void BMPArealNonStructuralFactory::loadBMP(string bmpDatabasePath)
{
	...
	m_bmpArealNonStructural = new BMPArealNonStructural(bmpDatabasePath,m_parameter,m_bmpId,"",m_distribution,m_scenarioId);
}
