...
string BMPBase::ReachBMPColumnNameFromBMPID(int reachbmpId)
{
	...
	switch(reachbmpId)
	{
		case BMP_TYPE_POINTSOURCE:				return BMP_NAME_POINTSOURCE;
		case BMP_TYPE_FLOWDIVERSION_STREAM:		return BMP_NAME_FLOWDIVERSION_STREAM;
		case BMP_TYPE_RESERVOIR:				return BMP_NAME_RESERVOIR;
		case BMP_TYPE_RIPARIANWETLAND:			return BMP_NAME_RIPARIANWETLAND;
		case BMP_TYPE_RIPARIANBUFFER:			return BMP_NAME_RIPARIANBUFFER;
		default:								return "";
	}
}