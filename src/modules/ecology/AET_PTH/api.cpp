...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddInput(VAR_SOL_COV, UNIT_CONT_KGHA, DESC_SOL_COV, Source_Module, DT_Raster1D); /// Since we have no sol_cov in database, this will be initialized as zero from other module.
	mdi.AddInput(VAR_SOL_NO3, UNIT_CONT_KGHA, DESC_SOL_NO3, Source_Module, DT_Raster2D);
	mdi.AddInput(VAR_SOMO, UNIT_DEPTH_MM, DESC_SOMO, Source_Module,DT_Raster2D);/// sol_st in SWAT
