...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddParameter(VAR_DEM, UNIT_LEN_M, DESC_DEM, Source_ParameterDB, DT_Raster);//from spatial database
	mdi.AddParameter(Tag_StationElevation, UNIT_LEN_M, Tag_StationElevation,Source_HydroClimateDB, DT_Array1D);/// from stations table
	...
	mdi.AddOutput(DataType_Prefix_DIS, UNIT_NON_DIM, DESC_NONE, DT_Raster); 
