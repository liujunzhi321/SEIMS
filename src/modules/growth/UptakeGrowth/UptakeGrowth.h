...
private:
	...
	float** m_layerFieldCapacity;//update on 2013.10.29
	float** m_layerWiltingPnt;//update on 2013.10.29
	...
	float* m_fSoilWater;//////must be total field capacity
	...
	float** m_layerSoilWater;//update on 2013.10.29
