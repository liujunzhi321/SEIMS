...
extern "C" WETSPA_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddParameter("Fieldcap","m3/m3","Soil field capacity","ParameterDB_WaterBalance", DT_Raster);								//0f
	mdi.AddParameter("Wiltingpoint","m3/m3","Plant wilting point moisture","ParameterDB_WaterBalance", DT_Raster);					//0w				
	...
	mdi.AddInput("D_PET","mm","pet","Module",DT_Raster);										//from interpolation module			PET
	mdi.AddInput("D_INET","mm","Evaporation From Interception Storage","Module",DT_Raster);	//from interception module			EI
	mdi.AddInput("D_DEET","mm","Distribution of depression ET","Module",DT_Raster);			//from depression module			ED
	...
	// set the parameters (non-time series)
	mdi.AddInput("D_GRRE","mm","percolation","Module",DT_Raster);								//from perculation module			
	mdi.AddInput("D_INFIL","mm","infiltration","Module",DT_Raster);							//from infiltration module
	mdi.AddInput("D_SSRU","mm", "Distribution of subsurface runoff.","Module", DT_Raster);			//form subsurface runoff module
