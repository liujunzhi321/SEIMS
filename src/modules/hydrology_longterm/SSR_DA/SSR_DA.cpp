...
bool SSR_DA::CheckInputData()
{
    ...
    if (m_somo == NULL)
        throw ModelException(MID_SSR_DA, "CheckInputData", "The soil moisture can not be NULL.");
    if (m_soilT == NULL)
    ...
    //	throw ModelException(MID_SSR_DA,"CheckInputData","The flow in percentage can not be NULL.");
