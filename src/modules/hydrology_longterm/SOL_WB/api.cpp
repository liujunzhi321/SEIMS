...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddInput("D_INLO","mm", "Interception Loss Distribution","Module", DT_Raster1D);
	mdi.AddInput("D_INET","mm", "Evaporation From Interception Storage","Module", DT_Raster1D);
	mdi.AddInput("D_DPST","mm", "depression storage","Module", DT_Raster1D);	
	mdi.AddInput("D_DEET","mm", "evaporation from depression storage","Module", DT_Raster1D);
	mdi.AddInput("D_INFIL","mm","Infiltration map of watershed","Module", DT_Raster1D);
	mdi.AddInput("D_SOET","mm","soil evapotranpiration","Module",DT_Raster1D);
	
	mdi.AddInput("D_Revap","mm","revap","Module",DT_Raster1D);
	mdi.AddInput("D_SURU","mm","surface runoff","Module",DT_Raster1D);
