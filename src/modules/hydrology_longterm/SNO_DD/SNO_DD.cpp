...
bool SNO_DD::CheckInputData(void)
{
    ...
    if (this->m_csnow == NODATA)
        throw ModelException(MID_SNO_DD, "CheckInputData", "The temperature impact factor can not be -99.");
    if (this->m_crain == NODATA)
        throw ModelException(MID_SNO_DD, "CheckInputData", "The rainfall impact factor can not be -99.");
    if (this->m_t0 == NODATA)
        throw ModelException(MID_SNO_DD, "CheckInputData", "The Snowmelt temperature can not be -99.");
    if (this->m_tsnow == NODATA)
        throw ModelException(MID_SNO_DD, "CheckInputData", "The snow fall temperature can not be -99.");
    return true;
}
