...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddInput(DataType_MeanTemperature,UNIT_TEMP_DEG,DESC_TMEAN,Source_Module,DT_Raster1D);/// mean air temperature
	mdi.AddInput(VAR_TMEAN1, UNIT_TEMP_DEG, DESC_TMEAN1, Source_Module, DT_Raster1D); /// mean air temperature of the day(d-1)
	mdi.AddInput(VAR_TMEAN1, UNIT_TEMP_DEG, DESC_TMEAN1, Source_Module, DT_Raster1D); /// mean air temperature of the day(d-2)
