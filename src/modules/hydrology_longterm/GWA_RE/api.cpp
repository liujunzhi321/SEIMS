...
extern "C" SEIMS_MODULE_API const char *MetadataInformation()
{
    ...
    mdi.AddOutput(VAR_REVAP, UNIT_NON_DIM, DESC_REVAP, DT_Raster1D); //used by soil water balance module
    mdi.AddOutput(VAR_RG, UNIT_NON_DIM, DESC_REVAP, DT_Array1D); //used by soil water balance module
    mdi.AddOutput(VAR_SBQG, UNIT_NON_DIM, DESC_SBQG, DT_Array1D); //used by channel flow routing module
    mdi.AddOutput(VAR_SBPET, UNIT_NON_DIM, DESC_SBPET, DT_Array1D);
    mdi.AddOutput(VAR_SBGS, UNIT_NON_DIM, DESC_SBGS, DT_Array1D);
