...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddParameter("Slope","%","the average slope of the subbasin","ParameterDB_WaterBalance", DT_Raster1D);
	...
	mdi.AddInput("D_DEET","mm","evaporation from the depression storage","Module",DT_Raster1D);
	mdi.AddInput("D_SOET","mm","evaporation from the soil water storage","Module",DT_Raster1D);
	mdi.AddInput("D_PET","mm","PET from the interpolation module","Module",DT_Raster1D);
	...
	mdi.AddOutput("Revap","","",DT_Raster1D);		//used by soil water balance module
