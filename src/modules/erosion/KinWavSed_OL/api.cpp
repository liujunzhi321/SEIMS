...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddInput("D_FlowWidth","m", "Flow width of overland plane",Source_Module,DT_Raster1D);		//FlowWidth, from Overland routing module
	mdi.AddInput("D_DETSplash","kg","the distribution of splash detachment",Source_Module,DT_Raster1D);	//Splash erosion, from splash erosion module
