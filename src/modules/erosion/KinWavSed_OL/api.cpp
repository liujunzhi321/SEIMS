...
extern "C" SEIMS_MODULE_API const char* MetadataInformation()
{
	...
	mdi.AddInput("D_FlowWidth","m", "Flow width of overland plane","Module",DT_Raster1D);		//FlowWidth, from Overland routing module
	mdi.AddInput("D_DETSplash","kg","the distribution of splash detachment","Module",DT_Raster1D);	//Splash eosion, from splash erosion module
	...
	mdi.AddOutput("SEDDEP","kg", "distribution of sediment deposition", DT_Raster1D);
	...
	mdi.AddOutput("SEDTOCH","kg", "distribution of sediment flowing to channel", DT_Raster1D);
