...
float KinWavSed_CH::complexSedCalc(float Qj1i1, float Qj1i, float Qji1,float Sj1i, float Sji1, float alpha, float dt,float dx)
{
...
void KinWavSed_CH::ChannelflowSedRouting(int iReach, int iCell, int id)
{
	...
	m_Qsn[iReach][iCell] = simpleSedCalc(m_ChQkin[iReach][iCell], Qin, Sin, m_TimeStep, WtVol, m_CHSed_kg[iReach][iCell]);
