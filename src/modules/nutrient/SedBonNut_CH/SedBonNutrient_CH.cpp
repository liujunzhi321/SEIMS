...
bool SedBonNutrient_CH::CheckInputData(void)
{
	...
	if(m_ChannelWH == NULL)
		throw ModelException("SedBonNutrient_CH","CheckInputData","The parameter: Channel water hight has not been set.");
	if(m_ChQkin == NULL)
		throw ModelException("SedBonNutrient_CH","CheckInputData","The parameter: Channel water flow has not been set.");
	...
	if(m_SedBonAmmoniumToCh == NULL)
		throw ModelException("SedBonNutrient_CH","CheckInputData","The parameter: m_SedBonAmmoniumToCh has not been set.");
...
void SedBonNutrient_CH::GetNutrientInFlow(int iReach, int iCell, int id)
{
	...
	m_SedBonP[iReach][iCell] = simpleSedCalc(m_ChQkin[iReach][iCell], Qin, PUp, m_dt, WtVol, m_SedBonP_KG[iReach][iCell]);
	m_SedBonAmmonium[iReach][iCell] = simpleSedCalc(m_ChQkin[iReach][iCell], Qin, NH4Up, m_dt, WtVol, m_SedBonAmmonium_KG[iReach][iCell]);
