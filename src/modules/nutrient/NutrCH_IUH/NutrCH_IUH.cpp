...
bool NutrientCH_IUH::CheckInputSize(const char *key, int n)
{
    if (n <= 0)
    {
...
bool NutrientCH_IUH::CheckInputData()
{
...
void NutrientCH_IUH::SetValue(const char *key, float value)
{
    string sk(key);
...
void NutrientCH_IUH::Set1DData(const char *key, int n, float *data)
{
...
void NutrientCH_IUH::Set2DData(const char *key, int nrows, int ncols, float **data)
{
    string sk(key);
...
void  NutrientCH_IUH::initialOutputs()
{
    if (m_nReaches <= 0)
...
void NutrientCH_IUH::NutrientinChannel(int i, int iCell, int id)
{
...
float NutrientCH_IUH::corTempc(float r20, float thk, float tmp)
{
    float theta = 0.f;
...
void NutrientCH_IUH::GetValue(const char *key, float *value)
{
	string sk(key);
...
void NutrientCH_IUH::Get2DData(const char *key, int *nRows, int *nCols, float ***data)
{
	string sk(key);
    *nRows = m_nReaches;
