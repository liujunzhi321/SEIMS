...
bool DissolvedNutrient_OL::CheckInputData(void)
{
	...
	{
		throw ModelException("DissolvedNutrient_OL","CheckInputData","You have not set the initial average concentration of nutrient-P variable.");
		return false;
	}
	if(this->m_initConcNH4 <= 0)
	{
		throw ModelException("DissolvedNutrient_OL","CheckInputData","You have not set the initial average concentration of nutrient-NH4 variable.");
		return false;
	}
	if(this->m_initConcNO3 <= 0)
	{
		throw ModelException("DissolvedNutrient_OL","CheckInputData","You have not set the initial average concentration of nutrient-NO3 variable.");
		return false;
	}
	if(m_clayFrac == NULL)
		throw ModelException("DissolvedNutrient_OL","CheckInputData","The parameter: clay fraction has not been set.");
	if(m_Porosity == NULL)
		throw ModelException("DissolvedNutrient_OL","CheckInputData","The parameter: soil porosity has not been set.");
	if(m_flowInIndex == NULL)
		throw ModelException("DissolvedNutrient_OL","CheckInputData","The parameter: flow in index has not been set.");
	if(m_routingLayers == NULL)
		throw ModelException("DissolvedNutrient_OL","CheckInputData","The parameter: routingLayers has not been set.");
	...
	if(m_sd == NULL)
		throw ModelException("DissolvedNutrient_OL","CheckInputData","The parameter: D_DPST(depression storage) has not been set.");
