...
/// Base class
PlantManagementOperation::PlantManagementOperation(int mgtOp, float husc, int year, int month, int day,
                                                   float *parameters)
...
ContinuousFertilizerOperation::ContinuousFertilizerOperation(int mgtOp, float husc, int year, int month, int day,
                                                             float *parameters) :
        PlantManagementOperation(mgtOp, husc, year, month, day, parameters)
{
...
ContinuousPesticideOperation::ContinuousPesticideOperation(int mgtOp, float husc, int year, int month, int day,
                                                           float *parameters) :
        PlantManagementOperation(mgtOp, husc, year, month, day, parameters)
{
