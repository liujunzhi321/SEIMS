...
{
	if(int(oneRow->size()) < FERTILIZER_PARAM_COUNT)	throw ModelException("FertilizerParameter","FertilizerParameter","oneRow should have 11 parameters at least!");
...
{
	if(count != FERTILIZER_PARAM_COUNT)	throw ModelException("FertilizerParameter","FertilizerParameter","Fertilizer should have 10 numeric parameters!");
