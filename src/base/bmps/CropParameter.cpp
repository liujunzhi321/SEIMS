...
{
	if(int(oneRow->size()) < CROP_PARAM_COUNT)	throw ModelException("CropParameter","CropParameter","oneRow should have 41 parameters at least!");
...
{
	if(count != CROP_PARAM_COUNT)	throw ModelException("CropParameter","CropParameter","Crop parameters should have 48 parameters!");
