...
public:
	...
	float dataType();///< climate data type for TSD and ITP
	string dataTypeString();///< data type	
	bool needDoVerticalInterpolation();///< vertical interpolation information for ITP
	string channelFlowRoutingMethod();///< get channel flow routing method
	string channelSedimentRoutingMethod();///< get channel sediment routing method	
